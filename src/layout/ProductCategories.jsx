            ...
            <div className="w-full flex flex-col lg:w-[83rem]">
                ...
                <div className="w-full flex flex-col items-center lg:flex-row lg:justify-between">
                    <Link to="/shop/cloths" className="w-full flex flex-col items-center">
                        <div className="w-full min-h-[15rem] max-w-[35rem] h-[22rem] bg-cover bg-no-repeat bg-center flex flex-col items-center justify-center text-light-text-color font-bold mb-5 lg:w-[16rem] lg:h-[16rem]" style={{backgroundImage: `url(${category1})`}}>
